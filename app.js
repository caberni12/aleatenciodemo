...
const MEDIA_VERSION = "20260916-r9160-rut-orders-pdf";
...
$("#checkoutBtn").addEventListener("click",()=>{if(!cart.length)return toast("Tu carrito está vacío");$("#orderSuccessPanel")?.classList.add("hidden");if($("#orderSuccessPdfPending"))$("#orderSuccessPdfPending").hidden=true;$("#submitOrderBtn")?.classList.remove("hidden");openModal("#checkoutModal")});$("#submitOrderBtn").addEventListener("click",submitOrder);wireRutField("#coRut");$("#orderSuccessClose")?.addEventListener("click",()=>{closeModal();$("#orderSuccessPanel")?.classList.add("hidden");$("#submitOrderBtn")?.classList.remove("hidden")});$("#whatsappFloat").addEventListener("click",e=>{e.preventDefault();openWhatsApp()});
