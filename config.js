window.ALE_ATENCIO_CONFIG = {
  // ALE ATENCIO R9.18.55 · Catálogo compacto/ficha interactiva sobre backend R9.18.54. Mayoristas + listas + tamaños + proveedores + mercadería + ingredientes + galería + stock transaccional.
