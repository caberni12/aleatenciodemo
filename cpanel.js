// ALE ATENCIO R9.18.96 · evaluación de aumento de cupo + historial crediticio 1–5 estrellas
...
function openClientEditor(id=""){
  try{
    ...
    const modal=$("#clientEditor");if(!modal)throw new Error("CLIENT_EDITOR_NO_ENCONTRADO");modal.classList.remove("hidden");modal.scrollTop=0;document.body.classList.add("client-editor-open");requestAnimationFrame(()=>$(c?"#clientName":"#clientRut")?.focus());
